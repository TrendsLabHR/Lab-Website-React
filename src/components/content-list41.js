...
const ContentList41 = (props) => {
  return (
    <div className="content-list41-container thq-section-padding">
      <div className="content-list41-thq-max-width-elm thq-flex-column thq-section-max-width">
        <div className="content-list41-thq-content-elm1 thq-flex-column">
          <ul className="content-list41-ul1 thq-flex-column">
            <li className="content-list41-li10 thq-flex-column list-item">
              <h2 className="content-list41-thq-heading7-elm thq-heading-2">
                {props.heading7 ?? (
                  <Fragment>
              ...
              <p className="content-list41-thq-content7-elm thq-body-small">
                {props.content7 ?? (
                  <Fragment>
                    <span className="content-list41-text22">
              ...
              <ul className="content-list41-ul2 thq-flex-column">
                <li className="list-item">
                  <h3 className="thq-heading-3">
                    {props.heading8 ?? (
                      <Fragment>
                        <span className="content-list41-text24">
                  ...
                  <p className="thq-body-small">
                    {props.content2 ?? (
                      <Fragment>
                        <span className="content-list41-text26">
                ...
                <li className="list-item">
                  <h3 className="thq-heading-3">
                    {props.heading9 ?? (
                      <Fragment>
                        <span className="content-list41-text32">
                  ...
                  <p className="thq-body-small">
                    {props.content9 ?? (
                      <Fragment>
                        <span className="content-list41-text29">
        ...
        <div className="content-list41-thq-content-elm2 thq-flex-column">
          <ul className="content-list41-ul3 thq-flex-column">
            <li className="content-list41-li13 thq-flex-column list-item">
              <h2 className="content-list41-thq-heading1-elm thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
                    <span className="content-list41-text10">
                      Privacy statement
                    </span>
                  </Fragment>
                )}
              </h2>
              <p className="content-list41-thq-content1-elm thq-body-small">
                {props.content1 ?? (
                  <Fragment>
              ...
              <ul className="content-list41-ul4 thq-flex-column">
                <li className="list-item">
                  <h3 className="thq-heading-3">
                    {props.heading2 ?? (
                      <Fragment>
                ...
                <li className="list-item">
                  <h3 className="thq-heading-3">
                    {props.heading3 ?? (
                      <Fragment>
                        <span className="content-list41-text28">
                  ...
                  <p className="thq-body-small">
                    {props.content3 ?? (
                      <Fragment>
                        <span className="content-list41-text23">
                          Lorem ipsum dolor sit amet. Est vitae blanditiis ab
                          aliquam tempore aut ipsam iusto in sunt repellat ex
                          voluptatum inventore ab facilis galisum ea consequatur
                          consequuntur. Ab voluptas voluptatem eum consequatur
                ...
                <li className="list-item">
                  <h3 className="thq-heading-3">
                    {props.heading4 ?? (
                      <Fragment>
                        <span className="content-list41-text21">
                    ...
                    {props.content4 ?? (
                      <Fragment>
                        <span className="content-list41-text18">
                          ...
                          quod internos qui provident quaerat hic minus eveniet
                          est officiis galisum sit rerum dignissimos. Sit
                          voluptatem alias et veniam rerum ea quod ipsam ut quam
                          neque est nihil repellat est aspernatur voluptatem est
                          voluptas ratione? Ea vero tempore At soluta temporibus
                          33 galisum excepturi quo modi distinctio. Qui dolor
                          soluta sit ipsam vitae et suscipit molestiae est
                          consequatur galisum aut sapiente voluptatem sed quas
                          eaque et minima minus? Rem soluta consequatur et velit
                          cupiditate sed eligendi laudantium rem pariatur
                          galisum sit mollitia debitis eum delectus ipsum aut
                          consequatur mollitia. Qui voluptatibus molestias ut
                          totam Quis ea unde dolorem sit animi eveniet et
                          galisum explicabo. Est culpa error ut voluptatibus
                          ...
                          praesentium fugiat eos veritatis quam ex modi autem et
                          sapiente dolorem?
                        </span>
                      </Fragment>
                    )}
                    ...
                    {props.content5 ?? (
                      <Fragment>
                        <span className="content-list41-text15">
                          ...
                          necessitatibus qui quia dolorem 33 earum reprehenderit
                          eum rerum blanditiis. Et vitae distinctio 33 magni
                          ratione ut odit rerum est nihil error et minus dolor
                          quo harum fugiat. Eos quam assumenda id fugit optio
                          aut magni sunt! Ut iure aliquam vel velit modi sit
                          voluptatibus atque ut corporis sint sit omnis enim a
                          pariatur officiis aut nulla voluptate. In facere
                          incidunt aut sapiente maxime qui quibusdam facilis non
                          officia consectetur sit laboriosam libero aut
                          cupiditate possimus ut sunt reiciendis. Et repudiandae
                          magnam aut quaerat ipsam aut repellat laboriosam. Ab
                          facilis deleniti ut voluptas molestiae sed omnis
                          maiores ut aliquid culpa vel nesciunt saepe. Aut
                          placeat aspernatur aut alias nihil vel neque
                          recusandae et corrupti accusantium ab quod temporibus
                          ut nulla eaque et magnam nemo. Ad sunt minus rem earum
                          delectus hic officia iste qui sunt quos non officiis
                          illo vel doloribus perspiciatis. Ab soluta eius sed
                          quidem dolores rem necessitatibus minus 33 minus
                          commodi. Nam repudiandae libero non laboriosam
                          voluptate et saepe fuga vel repudiandae pariatur aut
                          assumenda illo.
                        </span>
                      </Fragment>
                    )}
                ...
                <li className="list-item">
                  <h3 className="thq-heading-3">
                    {props.heading6 ?? (
                      <Fragment>
                        <span className="content-list41-text30">Cookies</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-small">
        ...
        <div className="content-list41-thq-content-elm3 thq-flex-column">
          <ul className="content-list41-ul5 thq-flex-column">
            <li className="content-list41-li19 thq-flex-column list-item">
              <h2 className="content-list41-thq-heading10-elm thq-heading-2">
                {props.heading10 ?? (
                  <Fragment>
                    <span className="content-list41-text25">Refund Policy</span>
                  </Fragment>
                )}
              </h2>
              <p className="content-list41-thq-content10-elm thq-body-small">
                {props.content10 ?? (
                  <Fragment>
                    <span className="content-list41-text33">
                      Lorem ipsum dolor sit amet. Vel dolores illum est aperiam
                      quis nam voluptatem quia et omnis autem qui dolore ullam
                      sed fugiat cumque! Qui accusamus assumenda et molestias
                      eius et error sunt. Id recusandae nostrum ea officiis
              ...
              <ul className="content-list41-ul6 thq-flex-column">
                <li className="list-item">
                  <h3 className="thq-heading-3">
                    {props.heading11 ?? (
                      <Fragment>
                        <span className="content-list41-text34">General</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-small">
                    {props.content11 ?? (
                      <Fragment>
                        <span className="content-list41-text20">
                          Lorem ipsum dolor sit amet. Nam nihil facilis sit
                          consequuntur internos qui minima rerum ut molestias
                          laudantium aut iusto deserunt. Aut voluptatibus
                          excepturi qui officia laudantium est repellendus
                ...
                <li className="list-item">
                  <h3 className="thq-heading-3">
                    {props.heading12 ?? (
                      <Fragment>
                        <span className="content-list41-text27">
                          Damages and issues
                        </span>
                      </Fragment>
                    )}
                  ...
                  <p className="thq-body-small">
                    {props.content12 ?? (
                      <Fragment>
                        <span className="content-list41-text31">
                          Lorem ipsum dolor sit amet. Est vitae blanditiis ab
                          aliquam tempore aut ipsam iusto in sunt repellat ex
                          voluptatum inventore ab facilis galisum ea consequatur
                          consequuntur. Ab voluptas voluptatem eum consequatur
