...
const ContentList11 = (props) => {
  return (
    <div className="content-list11-container thq-section-padding">
      <div className="content-list11-thq-max-width-elm thq-section-max-width">
        <div className="content-list11-thq-content-elm thq-flex-column">
          <ul className="content-list11-ul thq-flex-column">
            <li className="thq-flex-column list-item">
              <h2 className="content-list11-thq-heading1-elm thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
            ...
            <li className="list-item">
              <h3 className="thq-heading-3">
                {props.heading6 ?? (
                  <Fragment>
                    <span className="content-list11-text11">Cookies</span>
                  </Fragment>
                )}
              </h3>
              <p className="thq-body-small">
